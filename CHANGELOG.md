...
- Support for declaring the options for a slash command using
  ...
  [tanjun.annotations][].
- [tanjun.abc.NO_PASS][] for making command options as
  being not passed when they weren't provided.
...
- Renamed `tanjun.parser.UNDEFINED_DEFAULT` and
  `tanjun.commands.slash.UNDEFINED_DEFAULT` to
  `tanjun.abc.NO_DEFAULT`.
...
[Unreleased]: https://github.com/FasterSpeeding/Tanjun/compare/v2.12.0...HEAD
